...
/**
 * Created by piotr on 21/03/16.
 */
public class Tile {


    public TileRouteBackground backgroundPartOne;
    public TileRouteBackground backgroundPartTwo;
    ...
    public Tile(float screenWidth, float screenHeight, float widthBlocksCount, float heightBlocksCount, int widthNumber, int heightNumber, Route.Direction from, Route.Direction to, Route.Type t, Generator generator) {
    ...
    public Tile(float screenWidth, float screenHeight, float widthBlocksCount, float heightBlocksCount, Route route, Generator generator) {
    ...
    public Tile(float screenWidth, float screenHeight, float widthBlocksCount, float heightBlocksCount, Route route) {

        initData(screenWidth, screenHeight, widthBlocksCount, heightBlocksCount, route.x, route.y, route.from, route.to, Route.Type.valueOf(route.type.name()));


    }
    protected void initData(float screenWidth, float screenHeight, float widthBlocksCount, float heightBlocksCount, int widthNumber, int heightNumber, Route.Direction from, Route.Direction to, Route.Type t) {
        this.type = t;
