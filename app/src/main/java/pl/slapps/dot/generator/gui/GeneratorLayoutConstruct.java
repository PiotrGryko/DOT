    ...
    private View getProgressRow(final TileRoute route, int index) {
        ...
        btnSound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vi) {
                ...
                lv.setAdapter(new ArrayAdapter<String>(generator.view.context, android.R.layout.simple_list_item_1, generator.view.context.getActivityLoader().listSoundsFromAssets(null)));
