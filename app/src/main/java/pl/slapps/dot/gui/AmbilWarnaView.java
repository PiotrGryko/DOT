...
public class AmbilWarnaView extends LinearLayout{
    ...
    public void setListener(OnAmbilWarnaListener listener) {
        this.listener=listener;
    }

    public AmbilWarnaView(final Context context, AttributeSet set) {
        super(context,set);
        init(context);

    }
    public AmbilWarnaView(final Context context) {
        super(context);
        init(context);
    ...
    public void init(final Context context) {
       ...
       // this.alpha=0;
        ...
        final View view = LayoutInflater.from(context).inflate(R.layout.ambilwarna_view, null);
